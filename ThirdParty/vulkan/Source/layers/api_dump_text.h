...
std::ostream& dump_text_VkRenderPassSampleLocationsBeginInfoEXT(const VkRenderPassSampleLocationsBeginInfoEXT& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_array<const VkSubpassSampleLocationsEXT>(object.pSubpassSampleLocations, object.postSubpassSampleLocationsCount, settings, "const VkSubpassSampleLocationsEXT*", "const VkSubpassSampleLocationsEXT", "pSubpassSampleLocations", indents + 1, dump_text_VkSubpassSampleLocationsEXT);
    return settings.stream();
}
std::ostream& dump_text_VkComponentMapping(const VkComponentMapping& object, const ApiDumpSettings& settings, int indents)
{
